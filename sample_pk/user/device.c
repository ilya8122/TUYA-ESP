...
TIMER_ID heart_bit_timer;  /*!< timer with checking the regulators and taking readings from sensors*/

TIMER_ID sys_timer;   /*!< wf timer*/

TIMER_ID uart_timer;  /*!<timer with current protection and energy reading*/
...
int ISTOCHNIK/*!< source leak*/, LOW_LEVEL/*!<LOW_LEVEL source leak*/, HIGH_LEVEL/*!<HIGH_LEVEL source leak*/, temp_min, temp_max;

bool def_protechki; 

adc_config_t adc_config; /*!< adc config struct*/
...
LED_HANDLE light = NULL; /*!< wifi led indicator*/ 
